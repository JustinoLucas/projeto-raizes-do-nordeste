    ...
    <PageContainer>
      {approved ? (
        <div className="flex flex-col items-center justify-center py-16 animate-fade-in">
          <div className="w-28 h-28 bg-success/10 rounded-full flex items-center justify-center mb-6 animate-bounce">
          ...
          <div className="flex items-center gap-2 text-sm text-secondary font-medium mb-8">
            <Loader2 className="w-4 h-4 animate-spin" />
            Redirecionando para o acompanhamento...
          </div>
          <Button
            onClick={() => navigate(`/order/${approvedOrderId}`)}
